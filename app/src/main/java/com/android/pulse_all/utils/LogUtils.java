    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                dir = PulseApplication.getInstance().getExternalCacheDir() + File.separator + "log" + File.separator;
            } else {
                dir = PulseApplication.getInstance().getCacheDir() + File.separator + "log" + File.separator;
            }
        }
